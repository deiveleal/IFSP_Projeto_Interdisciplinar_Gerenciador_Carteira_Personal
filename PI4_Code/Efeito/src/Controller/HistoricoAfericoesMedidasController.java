...
public class HistoricoAfericoesMedidasController implements Initializable {
    ...
    @FXML
    private TextField txf_id_aluno;
    @FXML
    private TableView<RegistroMedidas> table_medicoes;
    @FXML
    private TableColumn<RegistroMedidas, Date> table_medicoes_col_data;
    @FXML
    private TableColumn<RegistroMedidas, Double> table_medicoes_col_peso;
    @FXML
    private TableColumn<RegistroMedidas, Double> table_medicoes_col_altura;
    @FXML
    private TableColumn<RegistroMedidas, Double> table_medicoes_col_pescoco;
    @FXML
    private TableColumn<RegistroMedidas, Double> table_medicoes_col_peito;
    @FXML
    private TableColumn<RegistroMedidas, Double> table_medicoes_col_braco;
    @FXML
    private TableColumn<RegistroMedidas, Double> table_medicoes_col_antebraco;
    @FXML
    private TableColumn<RegistroMedidas, Double> table_medicoes_col_cintura;
    @FXML
    private TableColumn<RegistroMedidas, Double> table_medicoes_col_quadril;
    @FXML
    private TableColumn<RegistroMedidas, Double> table_medicoes_col_coxa;
    @FXML
    private TableColumn<RegistroMedidas, Double> table_medicoes_col_panturrilha;
    @FXML
